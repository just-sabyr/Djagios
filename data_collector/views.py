...
class StatusView(TemplateView):
    ...
    def get_context_data(self, **kwargs: Any) -> dict[str, Any]:
        ...
        for node_and_data_type_pair in nodes_and_data_types:
            ...
            # setdefault() is needed as to ensure that data_point_map[data_type] is a dict
            # if setdefault() was not used the type of data_point_map[data_type] would have been something else
            # and the next line would have resulted in an error  
...
class NewAlertView(CreateView):
    ...
    def get_success_url(self) -> str:
        return reverse('data_collector:alerts-list')
